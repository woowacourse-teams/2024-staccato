...
class CategoryDefaultRepository
    ...
    constructor(
        ...
        override suspend fun createCategory(newCategory: NewCategory): ApiResult<Long> =
            categoryDataSource.createCategory(newCategory).handle { it.categoryId }
        ...
        override suspend fun leaveCategory(categoryId: Long): ApiResult<Unit> = categoryDataSource.deleteMeFromCategory(categoryId).handle()
    }
