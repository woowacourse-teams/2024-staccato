...
public record StaccatoDetailResponseV2(
    ...
    public StaccatoDetailResponseV2(Staccato staccato) {
        this(
                staccato.getId(),
                ...
                staccato.getCategory().getIsShared()
        );
    }

    public StaccatoDetailResponse toStaccatoDetailResponse() {
